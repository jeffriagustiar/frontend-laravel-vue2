        ...
        <div class="container">
          <div class="ht-left">
            <div class="mail-service">
              <i class="fa fa-envelope"></i> tes@gmail.com
            </div>
            <div class="phone-service"><i class="fa fa-phone"></i> +62</div>
          </div>
        </div>
      </div>
      <div class="container">
                  ...
                  <div class="cart-hover">
                    <div class="select-items">
                      <table>
                        <tbody v-if="cartUser.length > 0">
                          <tr v-for="(cart, n) in cartUser" :key="cart.id">
                            <td class="si-pic">
                              <img
                                class="photo-item"
                                :src="cart.photo"
                            ...
                            <td @click="removeItemC(n)" class="si-close">
                              <i class="ti-close"></i>
                            </td>
                          </tr>
                        </tbody>
                    ...
                    <div class="select-button">
                      <a href="#" class="primary-btn view-card">
                        <router-link to="/cart" style="color: #ffffff"
